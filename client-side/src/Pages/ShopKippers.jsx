     ...
     Omar Fahim
            ...
            <table className='table mt-10'>
                ...
                <tr className='text-center'>
                    ...
                    <td className="bg-white border border-blue-300 ">Service Amount : </td>
                    <td className="bg-white border border-blue-300"> <input type='checkbox' className='toggle toggle-info mt-7' onClick={handleAlert} checked={showAlert} defaultChecked />
                        <Modal
            id='firstModal'
