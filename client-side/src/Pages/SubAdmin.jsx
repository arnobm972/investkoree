...
<div className="flex gap-5 max-md:flex-col max-md:gap-0">
     ...
     Omar Fahim
                ...
                <div className=" ml-9 mt-10 flex  justify-between font-semibold ">
                    <div className="text-3xl text-gray-800">
                  SubAdmins
                    </div>
                    <Link to='/subadminadd'>
                    <button className='border-blue-500  mr-12 mt-2 border w-32 h-10 font-semibold rounded-md'>Add SubAdmin</button></Link>
                    </div>
            ...
            <table className='table mt-10'>
                ...
                <tr className='text-center'>
                    ...
                    <td className="bg-white border border-blue-300"> <span className='font-bold'>Reg.Date</span></td>
                ...
                <tr className='text-center'>
                    ...
                    <td className="bg-white border border-blue-300   ">Name </td>
         ...
         /> </td>
                    <td className="bg-white border border-blue-300 "><Link to='/subadminpermission'><button className='btn-active bg-blue-400 p-2 rounded-lg text-white'>Permission</button></Link> </td>
