        ...
        <form onSubmit={handleSubmit} >
          ...
          <div className="flex items-center mb-4">
            <input
              ...
              className="mr-2"
            />
            <button type="button" onClick={togglePasswordVisibility} className="absolute inset-y-0 top-20 left-[1195px] flex items-center pr-3 focus:outline-none">
                        {showPassword ? (
            ...
            <a
              href="#"
              className="text-black text-sm hover:text-blue-700 ml-auto"
            >
              Forgot Password?
            </a>
          </div>
