      ...
      <div className="forms-container">
        <div className="signin-signup">
          <form onSubmit={handleLogin} className="sign-in-form">
            <h2 className="lg:text-4xl text-black mb-2  md:text-2xl sm:text-lg">
              Investor Sign in
            </h2>
            ...
            <input
              ...
              className="login-btn solid lg:w-96 sm:w-52 md:w-80"
          ...
          <form className="sign-up-form" onSubmit={handleRegister}>
            ...
            <input
              ...
              className="login-btn   lg:w-96 sm:w-52 md:w-80 solid"
      ...
      <div className="panels-container">
        <div className="panel left-panel">
          <div className="content">
            ...
            <button
              className="login-btn2  lg:w-96 sm:w-36 md:w-80 transparent"
        ...
        <div className="panel right-panel">
          <div className="content">
            ...
            <button
              className="login-btn2 lg:w-96 sm:w-52 md:w-80  transparent"
