...
import Chart from 'chart.js/auto'; // Import Chart.js to ensure it's properly initialized
  ...
  datasets: [
    {
      ...
      barThickness: 15, // Set a fixed bar thickness
      maxBarThickness: 20, // Limit the max thickness
    },
  ],
};
  ...
  useEffect(() => {
    return () => {
      if (chart1Ref.current) {
        chart1Ref.current.destroy(); // Destroy chart instance
      }
      if (chart2Ref.current) {
        chart2Ref.current.destroy(); // Destroy chart instance
      }
    };
  }, []);
      ...
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-content flex flex-col p-10">
          ...
          />
              ...
              <p className="text-3xl font-bold mb-12 mt-16"> Invested Project List</p>
