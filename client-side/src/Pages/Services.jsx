    ...
    <>
     ...
     Omar Fahim
          ...
          <div className="flex flex-col px-9 mt-11 max-md:px-5 max-md:mt-10 max-md:max-w-full">
            ...
            <Link to='/servicesadd'>
            <button className="btn glass bg-white w-20">Add</button>
            </Link>
            </div>
                  ...
                  <div className="flex flex-col grow px-5 py-6 mx-auto w-full bg-white rounded-lg border border-solid border-blue-400 border-opacity-50 max-md:mt-6">
                    ...
                    <div className="flex gap-5 justify-between mt-5">
                      <div className="flex flex-col my-auto">
                        ...
                        <div className="mt-5 text-2xl font-bold text-blue-400">
                          $ 10
                        </div>
                      </div>
                      <div className="flex flex-col">
                        <div className="flex gap-1.5 text-xl text-right text-zinc-600">
                          <img
                            loading="lazy"
                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/02ab281f065e7c82f5213463fbcfb920a2d57198ef0d54db8c48f0ef8732e84f?apiKey=c7e8ca76374d4236bfa84e3c203f8c52&"
                            className="shrink-0 w-6 aspect-square"
                          />
                          <div>4.1 </div>
                        </div>
                        <input type='checkbox' className='toggle toggle-info mt-7' onClick={handleAlert} checked={showAlert} defaultChecked />
                        <Modal
            id='firstModal'
                ...
                <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col grow px-5 py-6 mx-auto w-full bg-white rounded-lg border border-solid border-blue-400 border-opacity-50 max-md:mt-6">
                    ...
                    <div className="flex gap-5 justify-between mt-5">
                      ...
                      <div className="flex flex-col">
                        <div className="flex gap-1.5 text-xl text-right whitespace-nowrap text-zinc-600">
                          <img
                            loading="lazy"
                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/02ab281f065e7c82f5213463fbcfb920a2d57198ef0d54db8c48f0ef8732e84f?apiKey=c7e8ca76374d4236bfa84e3c203f8c52&"
                            className="shrink-0 w-6 aspect-square"
                        ...
                        <input type='checkbox' className='toggle toggle-info mt-7' onClick={handleAlert2} checked={showAlert2} defaultChecked />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col grow px-5 py-6 mx-auto w-full bg-white rounded-lg border border-solid border-blue-400 border-opacity-50 max-md:mt-6">
                    ...
                    <div className="flex gap-5 justify-between mt-5">
                      ...
                      <div className="flex flex-col">
                        ...
                        <input type='checkbox' className='toggle toggle-info mt-7' onClick={handleAlert3} checked={showAlert3} defaultChecked />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col grow px-5 py-6 mx-auto w-full bg-white rounded-lg border border-solid border-blue-400 border-opacity-50 max-md:mt-6">
                    ...
                    <div className="flex gap-5 justify-between mt-5">
                      ...
                      <div className="flex flex-col">
                        ...
                        <input type='checkbox' className='toggle toggle-info mt-7' onClick={handleAlert4} checked={showAlert4} defaultChecked />
                      </div>
                    </div>
                  </div>
                </div>
