...
<div className="flex flex-col w-[16%] max-md:ml-0 max-md:w-full">
     ...
     Omar Fahim
            ...
            <button className="btn btn-active  mt-10  mb-10 ml-6 btn-ghost">
                <img
                loading="lazy"
            ...
            <div className='flex justify-between'>
                <div className=" ml-9 mt-10 flex flex-col items-start font-semibold max-w-[310px]">
                    ...
                    Order Details{" "}
                    <span className="text-base text-gray-700 ">(Active Order)</span>
                    </div>
                    <div className="mt-8 text-base font-medium text-zinc-700">
                    <span className="text-gray-600">Order ID :</span>{" "}
                    <span className="font-semibold text-zinc-700">750</span>
                    </div>
                    <div className="flex gap-4 self-stretch mt-5 text-lg text-blue-500">
                    <img
                        loading="lazy"
                        srcSet="https://cdn.builder.io/api/v1/image/assets/TEMP/66fa59e0fe9e6b63434ec3e0795dcbca2be40457bd0fec8c53e23b5133698aa4?apiKey=c7e8ca76374d4236bfa84e3c203f8c52&&apiKey=c7e8ca76374d4236bfa84e3c203f8c52&width=100 100w, https://cdn.builder.io/api/v1/image/assets/TEMP/66fa59e0fe9e6b63434ec3e0795dcbca2be40457bd0fec8c53e23b5133698aa4?apiKey=c7e8ca76374d4236bfa84e3c203f8c52&&apiKey=c7e8ca76374d4236bfa84e3c203f8c52&width=200 200w, https://cdn.builder.io/api/v1/image/assets/TEMP/66fa59e0fe9e6b63434ec3e0795dcbca2be40457bd0fec8c53e23b5133698aa4?apiKey=c7e8ca76374d4236bfa84e3c203f8c52&&apiKey=c7e8ca76374d4236bfa84e3c203f8c52&width=400 400w, https://cdn.builder.io/api/v1/image/assets/TEMP/66fa59e0fe9e6b63434ec3e0795dcbca2be40457bd0fec8c53e23b5133698aa4?apiKey=c7e8ca76374d4236bfa84e3c203f8c52&&apiKey=c7e8ca76374d4236bfa84e3c203f8c52&width=800 800w, https://cdn.builder.io/api/v1/image/assets/TEMP/66fa59e0fe9e6b63434ec3e0795dcbca2be40457bd0fec8c53e23b5133698aa4?apiKey=c7e8ca76374d4236bfa84e3c203f8c52&&apiKey=c7e8ca76374d4236bfa84e3c203f8c52&width=1200 1200w, https://cdn.builder.io/api/v1/image/assets/TEMP/66fa59e0fe9e6b63434ec3e0795dcbca2be40457bd0fec8c53e23b5133698aa4?apiKey=c7e8ca76374d4236bfa84e3c203f8c52&&apiKey=c7e8ca76374d4236bfa84e3c203f8c52&width=1600 1600w, https://cdn.builder.io/api/v1/image/assets/TEMP/66fa59e0fe9e6b63434ec3e0795dcbca2be40457bd0fec8c53e23b5133698aa4?apiKey=c7e8ca76374d4236bfa84e3c203f8c52&&apiKey=c7e8ca76374d4236bfa84e3c203f8c52&width=2000 2000w, https://cdn.builder.io/api/v1/image/assets/TEMP/66fa59e0fe9e6b63434ec3e0795dcbca2be40457bd0fec8c53e23b5133698aa4?apiKey=c7e8ca76374d4236bfa84e3c203f8c52&&apiKey=c7e8ca76374d4236bfa84e3c203f8c52"
                        className="object-contain shrink-0 w-11 rounded-full aspect-square"
                    />
                    <div className="flex-auto my-auto">Dry & Wash x 1, Iron Only x 2</div>
                    </div>
                </div>
                <div className='text-right mt-32 mr-12'>
                    <div >
                    <span className="text-gray-600">Quantity :</span>{" "}
                    <span className="font-semibold text-zinc-700">14</span>
                    </div>
            ...
            <table className="table ">
                ...
                <tr className='text-white text-center'>
                    <th className="bg-blue-400  border border-blue-300 w-56 ">Iron Only</th>
                    <th className="bg-blue-400 border border-blue-300 w-56">Dry Clean</th>
                    <th className="bg-blue-400 border border-blue-300 w-56">Wash & Iron</th>
                    <th className="bg-blue-300 border border-blue-300 w-56">Wash & Fold</th>
                </tr>
                </thead>
                <tbody>
                <tr className='text-center'>
                    <td className="bg-white border border-blue-300 ">Woman</td>
                    <td className="bg-white border border-blue-300">Man</td>
                    <td className="bg-white border border-blue-300">Woman</td>
                    <td className="border border-blue-300"></td>
                </tr>
                <tr  className='text-center'>
                    <td className="bg-light-blue-300 border border-blue-300  ">Shirt x4 $80</td>
                    <td className="bg-light-blue-300 border border-blue-300">Pant x4 $80</td>
                    <td className="bg-light-blue-300 border border-blue-300">Shirt x4 $80</td>
                    <td className="bg-light-blue-300 border border-blue-300"></td>
                </tr>
                <tr className='text-center' >
                    <td className="bg-light-blue-300 border border-blue-300">Pant x4 $80</td>
                    <td className="bg-light-blue-300 border border-blue-300">Shirt x4 $80</td>
                ...
                <tr className='text-center'>
                    <td className="bg-white border border-blue-300">Man</td>
                    <td className="bg-white border border-blue-300">Others</td>
                    <td className="bg-white border border-blue-300">Man</td>
                    <td className="bg-light-blue-300 border border-blue-300"></td>
                </tr>
                <tr className='text-center'>
            ...
            <table className='table mt-10'>
                <tbody>
                <tr className='text-center'>
                    <td className="bg-white border border-blue-300 ">Service Amount : <span className='font-bold'>$2000</span> </td>
                    <td className="bg-white border border-blue-300">Delivery Charge : <span className='font-bold'>$20</span></td>
                </tr>
                <tr className='text-center'>
                    <td className="bg-white border border-blue-300 ">Service Amount : <span className='font-bold'>$2000</span> </td>
                    <td className="bg-white border border-blue-300">Delivery Charge : <span className='font-bold'>$20</span></td>
            ...
            <div className="flex gap-5  mt-16 justify-between px-0.5 w-full text-sm font-medium leading-6  max-md:flex-wrap max-md:mr-2.5 max-md:max-w-full">
                        <div className="flex gap-0 text-center text-stone-500 max-md:flex-wrap">
                          <div className="justify-center px-12  py-4 text-base font-semibold leading-6 text-white bg-blue-400 max-md:px-5">
                            User Info
                          </div>
                          <div className="justify-center px-12 py-4 text-zinc-700 bg-white border  border-blue-500 border-solid max-md:px-5">
                          Order States
                          </div>
                          <div className="justify-center px-12 py-4 text-zinc-700 bg-white  border border-blue-500 border-solid max-md:px-5">
                           Pickup Rider
          ...
          <div className="flex flex-col px-9  max-md:px-5 max-md:max-w-full">
            ...
            <div className="flex flex-col items-start px-12 py-12 mt-9 rounded-lg border border-solid bg-slate-100 border-blue-500 border-opacity-50 max-md:px-5 max-md:max-w-full">
              ...
              <div className="mt-11 mb-3 text-lg font-semibold text-zinc-700 max-md:mt-10 max-md:max-w-full">
                Profile Picture
              </div>
              <div className='flex   w-full flex-row justify-between'>
                <div className='items-start'>
                <img className='w-[120px] h-[120px] rounded-xl' src={propic} alt="" />
                </div>
                <div className=''> <button className='border border-blue-400 p-3'>View Profile</button>
                </div>
              </div>
