...
<footer className="footer bg-slate-800 text-lg text-salmon py-10 px-24">
  <nav>
    ...
    <a className="link link-hover  opacity-90">Shamibag</a>
    <a className="link link-hover opacity-90">017238388448</a>
    <a className="link link-hover opacity-90">investkoree@gmail.com</a>
    
  </nav>
  <nav>
    <h6 className="footer-title opacity-100">About Us</h6>
    <a className="link link-hover  opacity-90">Overview</a>
    <a className="link link-hover opacity-90">Who we are</a>
    <a className="link link-hover opacity-90">What we do</a>
